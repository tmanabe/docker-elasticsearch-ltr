...
docker build -t elasticsearch-ltr:7.13.4 .
...
docker run -d -p 5005:5005 -p 7091:7091 -p 9200:9200 -p 9300:9300 -e "discovery.type=single-node" elasticsearch-ltr:7.13.4
